...
export class BlockListenerScheduler implements OnModuleInit {
    ...
    async onModuleInit(): Promise<void> {
        this.blockGap = this.configService.get<BigNumber>("network.avalanche.blockGap");            
        this.currentBlockNumber = this.configService.get<BigNumber>("network.avalanche.starterBlockNumber");
        this.batchLimit = this.configService.get<number>("network.avalanche.batchLimit");
